...
| B / Circle | `BTN_B` | `0x02` |
| X / Square | `BTN_X` | `0x03` |
| Y / Triangle | `BTN_Y` | `0x04` |
| LB / L1 | `BTN_LB` | `0x05` |
| RB / R1 | `BTN_RB` | `0x06` |
| LT / L2 | `BTN_LT` | `0x07` |
| RT / R2 | `BTN_RT` | `0x08` |
| SELECT / Back | `BTN_SELECT` | `0x09` |
| START / Options | `BTN_START` | `0x0A` |
| LS / L3 (左摇杆按下) | `BTN_LS` | `0x0B` |
| RS / R3 (右摇杆按下) | `BTN_RS` | `0x0C` |
| HOME / Guide / PS | `BTN_HOME` | `0x0D` |
| MISC (触控板/Mute) | `BTN_MISC` | `0x0E` |
| 十字键 上 | `BTN_DPAD_UP` | `0x10` |
| 十字键 下 | `BTN_DPAD_DOWN` | `0x11` |
| 十字键 左 | `BTN_DPAD_LEFT` | `0x12` |
| 十字键 右 | `BTN_DPAD_RIGHT` | `0x13` |
| EXTRA 1–8 | `BTN_EXTRA_1`–`BTN_EXTRA_8` | `0x14`–`0x1B` |
